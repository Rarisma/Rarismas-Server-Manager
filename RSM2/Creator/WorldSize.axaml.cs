...
namespace RSM2.Creator
{
    public partial class WorldSize : UserControl
    {
        public WorldSize()
        {
            ...
            {
                case "Terraria":
                    string[] AllowedSizes = { "Large", "Medium", "Small" };
                    SizeBox.Items = AllowedSizes;
                    break;
            }
        }
        ...
        private void Continue(object sender, RoutedEventArgs e) { ServerInfo.MainWindow.Content = new Difficulty();  }
    }
}
